export default function SpamComplaint() {
    return (
        <div className="inboxwp-bg-[#faf8e3] inboxwp-w-12 inboxwp-h-12 inboxwp-rounded-md">
            <svg className="inboxwp-absolute inboxwp-w-[50%] inboxwp-mt-[25%] inboxwp-ml-[25%] inboxwp-h-[50%]]" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                <path
